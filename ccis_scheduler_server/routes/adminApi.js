...
router.get("/:code/view-archive-meeting",jwtVerify, adminController.adminViewArchivedMeeting)
router.get("/download-excel-sheet", jwtVerify, adminController.downloadExcelSheet)
//POST
